...
AutoForward has a mobile app which makes editing values easier.
...
I highly suggest to install and connect the mobile app. Use `/get_app` to get the links.
...
- The easiest is to use the mobile App (click on the task, *Edit Target* and select the bot)
